    ...
    printAreas: [
      {
        ...
        dpiRecommendation: 300, lockAspectRatio: false, allowText: true, allowImages: true,
      },
      {
        id: 'back', label: 'Back',
        bounds: { x: 30, y: 20, width: 40, height: 35, rotation: 0 },
      ...
      },
      {
        ...
        dpiRecommendation: 300, lockAspectRatio: true, allowText: true, allowImages: true,
      },
    ],
    defaultWeight: 180,
  ...
  },
  {
    ...
    printAreas: [
      ...
      },
      {
        ...
        maxUploadSizeBytes: 5242880, acceptedFileTypes: ['image/png', 'image/svg+xml'],
        dpiRecommendation: 300, lockAspectRatio: false, allowText: false, allowImages: true,
      },
    ],
    defaultWeight: 320,
    ...
    printAreas: [
      {
        ...
        dpiRecommendation: 300, lockAspectRatio: true, allowText: false, allowImages: true,
      },
    ],
    defaultWeight: 500,
